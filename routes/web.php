...
use App\Http\Controllers\tarificationController;
...
return redirect()->route("form/leavesemployee/new");});
Route::get('tarification',[tarificationController::class,'showTarification'])->name('listTarification');
Route::get('addTarification',[tarificationController::class,'addTarification'])->name('addTarification');
Route::get("/delete/tarification/{id}",[tarificationController::class,'destroy'])->name('destroyTarif');
Route::get('planification');
